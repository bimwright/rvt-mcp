...
The canonical text, including the pledge, standards, enforcement responsibilities, and guidelines, lives at:

https://www.contributor-covenant.org/version/2/1/code_of_conduct/

## Scope

Applies to all project spaces: GitHub issues and pull requests, discussions, commit messages, and any other channel where a contributor is acting on behalf of the project.
